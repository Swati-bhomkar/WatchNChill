...
export const dummyShowsData = [
    ...
    },
    {
        ...
        "genres": [
            { "id": 10751, "name": "Sci-fi" },
            { "id": 35, "name": "Fantasy" },
            { "id": 878, "name": "Comedy" },
            { "id": 8781, "name": "Mystery" }
        ],
    ...
    },
   {
        ...
        "overview": "After the devastating events of Avengers: Infinity War, the universe is in ruins due to the efforts of the Mad Titan, Thanos. With the help of remaining allies, the Avengers must assemble once more in order to undo Thanos' actions and restore order to the universe once and for all, no matter what consequences maybe in store.",
